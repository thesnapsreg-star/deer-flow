...
from research_core.config.configuration import get_recursion_limit
from research_core.graph import build_graph
from research_core.graph.utils import build_clarified_topic_from_history
...
async def run_agent_workflow_async(
    ...
    if final_state and isinstance(final_state, dict):
        from research_core.graph.nodes import needs_clarification
